...
gsap.fromTo(".loading-screen", { opacity: 1 }, { opacity: 0, duration: 1.5, delay: 2.8, ease: "power1.inOut", onComplete: function() { document.querySelector(".loading-screen").classList.add("hidden") }});
...
window.addEventListener("scroll", function() {
   document.querySelector('header').classList.toggle("not-top", window.scrollY > 0);
})